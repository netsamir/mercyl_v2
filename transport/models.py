...
class Cost_Purchase(models.Model):
    name = models.CharField(max_length=120, default='Agency R.')
    plane = models.DecimalField(max_digits=10, decimal_places=2, default=500)
    train = models.DecimalField(max_digits=10, decimal_places=2, default=150)
    car = models.DecimalField(max_digits=10, decimal_places=2, default=30)
    phone = models.DecimalField(max_digits=10, decimal_places=2, default=10)
    dhl = models.DecimalField(max_digits=10, decimal_places=2, default=60)
    various = models.DecimalField(max_digits=10, decimal_places=2, default=100)
    currency = models.CharField(max_length=3, default='EUR')
